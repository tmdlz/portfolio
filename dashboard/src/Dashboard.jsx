...
function Stat({ label, value, suffix = "", prefix = "", sub, color = T.accent }) {
  ...
  return (
    <div style={{
      ...
      border: "none", borderRadius: 14, padding: "16px 18px", flex: 1, minWidth: 180,
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    ...
                    <div key={i} style={{
                      ...
                      <span style={{ fontSize: 12, fontWeight: 700, color: f.color, fontFamily: T.mono, whiteSpace: "nowrap", marginLeft: 12 }}>{f.impact}</span>
                    </div>
                  ))}
                </div>
              </Card>
